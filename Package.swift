    ...
    targets: [
        .target(
            ...
            resources: [
                ...
                // contracts.json — bank-grade behavioural contracts
                // sidecar consumed by the public `CrossdeckContracts`
                // API. Regenerated by `Scripts/emit-contracts.mjs`
                // and committed; CI's `contract-audit` job pins it
                // to `contracts/**/*.json` at the monorepo root.
                .copy("Resources/contracts.json"),
            ],
            swiftSettings: [
